...
export default function SingleVehicleDetails() {
    ...
    const [vehicleSwapDetails, setVehicleSwapDetails] = useState(null);
    const [tripPaymentTokens, setTripPaymentTokens] = useState(null);
    const [tripModificationDetails, setTripModificationDetails] = useState(null);
    const [tripStatusTransactionResponses, setTripStatusTransactionResponses] = useState(null);
